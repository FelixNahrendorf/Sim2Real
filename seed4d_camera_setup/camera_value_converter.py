...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  python3 camera_value_converter.py "transforms_*.json" --output-dir ./processed
  ...
  python3 camera_value_converter.py "data/*.json" --output-dir ./results
    ...
    parser.add_argument(
        'input_pattern',
        help='Input file pattern (supports glob patterns like "transforms_*.json" or single file)'
    )
